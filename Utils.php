...
class Calendar extends gOauth {
    ...
    function getEvents($calId, $start, $end) {
        $url="https://www.googleapis.com/calendar/v3/calendars/".$calId."/events?singleEvents=true&timeMin=".$start."T01%3A00%3A00%2B01%3A00&fields=items(description%2ChtmlLink%2Csummary%2Clocation%2Cstart%2Cend)&timeMax=".$end."T23%3A59%3A00%2B01%3A00&access_token=".$this->getAccessToken();
